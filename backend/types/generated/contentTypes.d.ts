...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  collectionName: 'news';
  info: {
    description: 'News content managed in Strapi';
    displayName: 'News';
    pluralName: 'news';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    relatedProducts: Schema.Attribute.JSON;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product content managed in Strapi';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    taobaoLink: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
