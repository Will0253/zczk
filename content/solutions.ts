...
export const solutions: Solution[] = [
  {
    ...
    scenario: 'highway',
    image: 'https://images.unsplash.com/photo-1631332419486-daf1322122c6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    painPoints: [
      '夜间及恶劣天气视线差',
      '驾驶员疲劳驾驶导致闯入',
      '传统锥桶倒伏无法及时发现'
  ...
  },
  {
    ...
    scenario: 'tunnel',
    image: 'https://images.unsplash.com/photo-1722532828784-a4cdc9b73fcb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    painPoints: [
      '封闭空间信号差',
      '有毒有害气体监测困难',
      '人员位置难以追踪'
  ...
  },
  {
    ...
    scenario: 'bridge',
    image: 'https://images.unsplash.com/photo-1740303226597-6521195103bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    painPoints: [
      '结构老化难以预测',
      '人工巡检效率低',
      '突发损伤难发现'
