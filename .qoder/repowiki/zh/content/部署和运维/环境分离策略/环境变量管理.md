...
- [ops/.env.prod.example](file://ops/.env.prod.example)
- [ops/.env.dev.example](file://ops/.env.dev.example)
...
**图表来源**
- [ops/.env.prod.example](file://ops/.env.prod.example#L1-L27)
- [ops/.env.dev.example](file://ops/.env.dev.example#L1-L15)
- [ops/generate-secrets.sh](file://ops/generate-secrets.sh#L1-L74)
...
**图表来源**
- [ops/generate-secrets.sh](file://ops/generate-secrets.sh#L28-L71)
- [ops/docker/docker-compose.prod.yml](file://ops/docker/docker-compose.prod.yml#L10-L11)
...
**图表来源**
- [ops/generate-secrets.sh](file://ops/generate-secrets.sh#L7-L26)
- [ops/deploy.sh](file://ops/deploy.sh#L30-L56)
- [ops/nginx/sites.conf](file://ops/nginx/sites.conf#L1-L63)
...
- [frontend/.env.example](file://frontend/.env.example#L1-L2)
- [backend/config/database.ts](file://backend/config/database.ts#L25-L51)
- [ops/generate-secrets.sh](file://ops/generate-secrets.sh#L44-L71)
- [ops/docker/docker-compose.prod.yml](file://ops/docker/docker-compose.prod.yml#L10-L11)
- [ops/nginx/sites.conf](file://ops/nginx/sites.conf#L1-L63)
...
**章节来源**
- [ops/deploy.sh](file://ops/deploy.sh#L8-L56)
- [ops/nginx/sites.conf](file://ops/nginx/sites.conf#L1-L63)
...
- 开发环境专用变量（6个）
  - NODE_ENV：开发环境标识
  - DATABASE_CLIENT：数据库客户端类型
  - DATABASE_FILENAME：SQLite 数据库文件路径
  - 开发密钥：预设的开发用密钥

**章节来源**
- [ops/.env.prod.example](file://ops/.env.prod.example#L20-L27)
- [ops/.env.dev.example](file://ops/.env.dev.example#L8-L15)

### 配置文件与脚本参考路径
- 生成密钥脚本：ops/generate-secrets.sh
- 生产部署脚本：ops/deploy.sh
- 回滚脚本：ops/rollback.sh
- 开发环境启动脚本：ops/dev.sh
...
**章节来源**
- [ops/generate-secrets.sh](file://ops/generate-secrets.sh#L28-L38)
- [ops/docker/docker-compose.prod.yml](file://ops/docker/docker-compose.prod.yml#L10-L11)
- [ops/nginx/sites.conf](file://ops/nginx/sites.conf#L24-L29)