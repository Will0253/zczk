...
export function Navigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4"> {/* Changed lg:px-8 to lg:px-4 to better align with banner content */}
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link to="/" className="flex-shrink-0 lg:-ml-1 transform hover:scale-105 transition-transform duration-300 relative z-50">
