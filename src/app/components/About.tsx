                  ...
                  <div className="flex -space-x-4">
                    {[1, 2, 3, 4].map(i => (
                      <div key={i} className="w-12 h-12 rounded-full border-2 border-[#11345b] bg-white/10 backdrop-blur-md overflow-hidden ring-2 ring-[#fdbd00]/20">
                        <ImageWithFallback src={`https://images.unsplash.com/photo-1759884247387-a5d791ffb2bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=100`} alt="Avatar" className="w-full h-full object-cover opacity-80" />
                      </div>
                    ))}
            ...
            <div className="lg:col-span-5 relative">
              ...
              >
                ...
                <div className="absolute inset-0 rounded-[60px] overflow-hidden border border-white/10 shadow-[0_0_100px_rgba(17,52,91,0.5)] z-10">
                  <ImageWithFallback src="https://images.unsplash.com/photo-1737531691773-2d4f1b79f650?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080" alt="Tech Dashboard" className="w-full h-full object-cover grayscale-[30%]" />
                </div>
        ...
        <section className="py-32 px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
            <div className="relative">
              ...
              >
                <ImageWithFallback src="https://images.unsplash.com/photo-1762599180260-deb643596e99?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080" alt="Company Vision" className="w-full aspect-[4/5] object-cover transition-transform duration-1000 group-hover:scale-105" />
              ...
              >
                <ImageWithFallback src="https://images.unsplash.com/photo-1716772912302-6452fea6c2e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" alt="Hardware Detail" className="w-full aspect-square object-cover transition-transform duration-1000 group-hover:scale-110" />
              </motion.div>
                ...
                >
                  {adv.img && (
                    <div className="absolute inset-0 z-0 opacity-10 group-hover:opacity-20 transition-opacity duration-700">
                      <ImageWithFallback src={adv.img} alt={adv.title} className="w-full h-full object-cover" />
