import { Zap, Wifi, Shield, ArrowRight, Activity, ChevronRight } from 'lucide-react';
...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0a1f3d]">
      ...
      <div className="max-w-7xl w-full mx-auto px-6 sm:px-8 lg:px-12 relative z-10 py-20 lg:py-28">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-5">
            <button className="group relative px-8 py-4 bg-[#fdbd00] text-[#11345b] rounded-lg overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(253,189,0,0.4)] hover:-translate-y-1">
            ...
            <button className="group relative px-8 py-4 bg-transparent border border-white/20 text-white rounded-lg overflow-hidden transition-all duration-300 hover:border-[#fdbd00]/50 hover:bg-white/5 hover:-translate-y-1">
              <span className="relative z-10 font-bold text-lg flex items-center justify-center gap-2">
                立即咨询合作
      ...
      {/* CSS Animation for specific effects moved to global CSS */}
    </section>
  );
}