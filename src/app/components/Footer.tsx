import { MessageSquare, Phone, Mail, MapPin, ChevronRight, ArrowRight, ExternalLink, Linkedin, Github, MessageCircle } from 'lucide-react';
import { motion } from 'motion/react';

export function Footer() {
  const quickLinks = ['首页', '关于我们', '产品中心', '解决方案', '资讯中心', '联系我们'];
    ...
    <footer className="relative bg-[#0a1f3d] text-white overflow-hidden border-t border-white/5 pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            {/* Logo - Optimized Size and Proportions */}
            ...
            <p className="text-gray-400 leading-relaxed text-sm">
              智慧交通安全预警设备研发与应用服务商，致力于通过科技创新提升道路交通安全水平，构建车路协同的智慧交通新生态。
            </p>

            <div className="flex items-center gap-3">
              {[
                { icon: MessageCircle, label: '微信' },
                { icon: Linkedin, label: '领英' },
          ...
          <motion.div variants={itemVariants} className="lg:pl-8">
            ...
            <ul className="space-y-4 text-sm">
              {['智能预警设备', '智慧交通安全解决方案', '高速养护监管平台', '定制开发服务', '数据分析与应用'].map((item, i) => (
                <motion.li 
                  key={i} 
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:18823780560" className="text-white text-base font-bold tracking-tight hover:text-[#fdbd00] transition-colors">
                    18823780560
                  </a>
                </div>
              </motion.div>
              ...
              <div className="space-y-3 pl-1">
                ...
                <div className="flex items-start gap-4 text-sm text-gray-400 group hover:text-white transition-colors cursor-pointer">
                  ...
                  <span className="leading-relaxed">深圳市龙华区...</span>
                </div>
              </div>
            </div>
        ...
        >
          <p>© 2025 深圳市中创智控技术有限公司 版权所有</p>
          <div className="flex gap-8">
            {['隐私政策', '服务条款', '网站地图'].map((link, idx) => (
              <a key={idx} href="#" className="hover:text-[#fdbd00] transition-colors relative group">
                {link}
