        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <Link to="/solutions/highway-safety" className="inline-flex items-center gap-3 px-8 py-4 bg-[#11345b] text-white rounded-2xl font-bold group hover:shadow-xl hover:shadow-[#11345b]/20 transition-all">
                <span>查看详细配置方案</span>
          ...
          <div className="bg-[#11345b] rounded-[60px] p-12 md:p-24 relative overflow-hidden text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <button className="w-full sm:w-auto px-10 py-5 bg-[#fdbd00] text-[#11345b] font-black rounded-[32px] flex items-center justify-center gap-3 shadow-2xl hover:scale-105 transition-all">
